...
<html lang="en">
  ...
  <body class="flex">
    ...
    <main class="ml-[19rem] flex-1 flex flex-col font-inter h-screen">
      ...
      <form class="flex-1 bg-[#F5F5f5] py-5 px-8 flex flex-col flex-wrap gap-5" id="addKidForm" method="POST" action="{{ route('children.update', ['children'=>$children])}}" enctype="multipart/form-data">
        @csrf
        @method('put')
              ...
              <div class="flex flex-wrap gap-6 pt-5">
                <div class="flex-1 flex flex-col gap-2">
                  ...
                  <input
                    ...
                    value="{{ $children->child_id_number }}"
                  />
                </div>
                <div class="flex-1 flex flex-col gap-2">
                ...
                <div class="flex-1 flex flex-col gap-2">
                  ...
                  <input
                    ...
                    value="{{ $children->date_of_enrollment }}"
                  />
                </div>
              </div>
            </div>
          ...
          <div class="flex flex-col flex-wrap gap-6 pt-5 h-[460px]">
            ...
            <div class="flex-1 flex flex-col gap-2">
              ...
              <input
                ...
                value="{{ $children->home_phone_number }}"
              />
            </div>
            <div class="flex-1 flex flex-col gap-2">
              ...
              <input
                ...
                value="{{ $children->mother_phone_number }}"
              />
            </div>
            <div class="flex-1 flex flex-col gap-2">
              ...
              <input
                ...
                value="{{ $children->father_phone_number }}"
              />
            </div>
            <div class="flex-1 flex flex-col gap-2">
              ...
              <input
                ...
                value="{{ $children->father_passport_series }}"
              />
            </div>
            <div class="flex-1 flex flex-col gap-2">
              ...
              <input
                ...
                value="{{ $children->mother_passport_series }}"
              />
            </div>
          </div>
        </div>
